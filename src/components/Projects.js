      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full pt-10 pb-10">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {projects.map(({ id, src, name, type, client, server, live }) => (
            <div
              key={id}
              className="shadow-md shadow-blue-200 bg-blue-900 rounded-lg"
            >
              <img
                src={src}
                alt=""
              ...
              <div className="flex-col items-center justify-center">
                ...
                <div className="flex items-center justify-center">
                  ...
                  <button
                    ...
                    className="w-1/2 px-2 py-3 m-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 cursor-pointer duration-200 hover:scale-110"
                  >
                    More Details
                  </button>
                </div>
